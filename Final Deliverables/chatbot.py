...
for file in os.listdir('C:/Users/Fantasy-PC/PycharmProjects/chatbotpyflask/data/'):

    chats = open('C:/Users/Fantasy-PC/PycharmProjects/chatbotpyflask/data/' + file, 'r').readlines()
